...
public class VodUtil {
    ...
    /**
     * LTAI5tBmjyEkgjc9FdAWyYh7
     * S05f7OwIFxZUXUDBP7LzGMVaSuHata
     *
     * @param argv
     */
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tBmjyEkgjc9FdAWyYh7";
        //您的AccessKeySecret
        String accessKeySecret = "S05f7OwIFxZUXUDBP7LzGMVaSuHata";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\JavaCode\\mooc\\admin\\public\\static\\image\\小节视频\\test1.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
    ...
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient vodClient) throws ClientException {
        ...
        request.setFileName("vod_test-123.mp4");
        request.setTitle("this is title");
        //request.setDescription("this is desc");
        //request.setTags("tag1,tag2");
        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(2735L);
        request.setTemplateGroupId("e0f7509a64b071bd17e7530e296c85cd");
